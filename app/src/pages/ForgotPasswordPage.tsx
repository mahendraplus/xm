            ...
            >
                <Card className="glass border-white/10">
                    <CardHeader className="text-center">
                        ...
                        <CardTitle className="text-2xl text-[#1f2937]">Forgot Password</CardTitle>
                    ...
                    <CardContent className="space-y-4">
                        {status === 'idle' ? (
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <Input
                                    ...
                                    required
                                    className="bg-white border-[#d1d5db] text-[#111827] placeholder:text-[#9ca3af]"
                                />
                                <Input
                                    type="text"
                        ...
                        <div className="text-center pt-2">
                            <button onClick={() => navigate('auth')}
                                className="text-sm text-[#6d28d9] hover:underline transition-colors font-medium">
                                Back to Login
                            </button>
                        </div>
                    </CardContent>
